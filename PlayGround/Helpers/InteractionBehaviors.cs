...
{
    class InteractionBehaviors : DependencyObject, IInteractionTrackerOwner, IBehavior
    {
        ...
        public static readonly DependencyProperty InfoContentProperty =
            DependencyProperty.Register("InfoContent", typeof(FrameworkElement), typeof(InteractionBehaviors), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty InfoContainerProperty =
            DependencyProperty.Register("InfoContainer", typeof(FrameworkElement), typeof(InteractionBehaviors), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty PhotoContentProperty =
            DependencyProperty.Register("PhotoContent", typeof(FrameworkElement), typeof(InteractionBehaviors), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty HittestContentProperty =
            DependencyProperty.Register("HittestContent", typeof(FrameworkElement), typeof(InteractionBehaviors), new PropertyMetadata(null, OnHittestContentChanged));
        ...
        private static void OnHittestContentChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                var thisBehavior = d as InteractionBehaviors;
